...
function wp_bootstrap_starter_customize_register( $wp_customize ) {
    ...
    $wp_customize->add_section(
        'typography',
        array(
            'title' => __( 'Preset Styles', 'fasco' ),
            //'description' => __( 'This is a section for the typography', 'fasco' ),
            'priority' => 20,
        )
    );
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'preset_style_setting', array(
        'label' => __( 'Typography', 'fasco' ),
        'section'    => 'typography',
        'settings'   => 'preset_style_setting',
        'type'    => 'select',
        'choices' => array(
            'default' => 'Default',
			'titilium-opensans' => 'Titilium / Opensans',
    ...
    $wp_customize->add_control(
        new WP_Customize_Color_Control(
            ...
            'header_bg_color',
            array(
                'label'      => __( 'Header Banner Background Color', 'fasco' ),
    ...
    $wp_customize->add_setting( 'header_banner_tagline_setting', array(
        'default' => __( 'To customize the contents of this header banner and other elements of your site go to Dashboard - Appearance - Customize','fasco' ),
        'sanitize_callback' => 'wp_filter_nohtml_kses',
    ) );
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'header_banner_tagline_setting', array(
        'label' => __( 'Banner Tagline', 'fasco' ),
        'section'    => 'header_image',
    ...
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'header_banner_visibility', array(
        ...
        'label'    => __('Remove Header Banner', 'fasco'),
        'section'    => 'header_image',
        'type'     => 'checkbox',
    ) ) );
    ...
    $wp_customize->add_section(
        'ks_image',
        array(
            'title' => __( 'Sambutan Kepala Sekolah', 'fasco' ),
            'priority' => 40,
        )
    );
    ...
    $wp_customize->add_control(
        'ks_img',
        array(
            'label' => __( 'Foto kepala Sekolah', 'fasco' ),
            'section' => 'ks_images',
            'type' => 'text',
        )
    );
    ...
    $wp_customize->add_setting( 'nama_ks_title_setting', array(
        'default' => __( 'H. Sukarno', 'fasco' ),
        'sanitize_callback' => 'wp_filter_nohtml_kses',
    ) );
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'nama_ks_title_setting', array(
        'label' => __( 'Nama Kepala Sekolah', 'fasco' ),
        'section'    => 'ks_image',
        'settings'   => 'nama_ks_title_setting',
        'type' => 'text'
    ) ) );

    $wp_customize->add_setting( 'sambutan_ks_tagline_setting', array(
        'default' => __( 'Isilah Kata Sambutan Kepala Sekolah','fasco' ),
        'sanitize_callback' => 'wp_filter_nohtml_kses',
    ) );
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'sambutan_ks_tagline_setting', array(
        'label' => __( 'Isi Sambutan Kepala Sekolah', 'fasco' ),
        'section'    => 'ks_image',
        'settings'   => 'sambutan_ks_tagline_setting',
        'type' => 'text'
    ) ) );
    $wp_customize->add_setting( 'nama_ks_visibility', array(
        'capability' => 'edit_theme_options',
        'sanitize_callback' => 'themeslug_sanitize_checkbox',
    ) );
    $wp_customize->add_control( new WP_Customize_Control($wp_customize, 'nama_ks_visibility', array(
        'settings' => 'nama_ks_visibility',
        'label'    => __('Remove Header Banner', 'fasco'),
        'section'    => 'ks_image',
        'type'     => 'checkbox',
    ) ) );
   ...
   $wp_customize->add_section(
        ...
        array(
            'title' => __( 'Other Customizations', 'fasco' ),
            //'description' => __( 'This is a section for the header banner Image.', 'fasco' ),
            'priority' => 50,
        )
    );
    $wp_customize->add_section(
        'colors',
        array(
            'title' => __( 'Background Color', 'fasco' ),
            //'description' => __( 'This is a section for the header banner Image.', 'fasco' ),
            'priority' => 60,
    ...
    $wp_customize->add_section(
        'background_image',
        array(
            'title' => __( 'Background Image', 'fasco' ),
            //'description' => __( 'This is a section for the header banner Image.', 'fasco' ),
            'priority' => 70,
            'panel' => 'styling_option_panel',
        )
    ...
    $wp_customize->add_control( 
        'cdn_assets',
        array(
            'label' => __( 'Use CDN for Assets', 'fasco' ),
            'description' => __( 'All Bootstrap Assets and FontAwesome will be loaded in CDN.', 'fasco' ),
    ...
    $wp_customize->add_control( new WP_Customize_Image_Control( $wp_customize, 'wp_bootstrap_starter_logo', array(
        'label'    => __( 'Upload Logo (replaces text)', 'fasco' ),
